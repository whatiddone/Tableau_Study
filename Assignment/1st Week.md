...
![주문시트](../image/2nd_week_image/주문.png)
...
```
- 데이터 유형
![데이터유형](../image/2nd_week_image/datatype.png)
...
![innerjoin](../image/2nd_week_image/innerjoin.png)

3027개의 주문이 반품되었다고 표시됩니다.
...
- 필드 값(컬럼)의 이름, 데이터 유형, 개수는 모두 같기 때문에 유니온이 가장 적합합니다.
![와일드카드](../image/2nd_week_image/wildcard.png)
