...
```
![파이차트](/image/3rd_week_image/파이차트.png)
...
```
![도넛차트](/image/3rd_week_image/도넛차트.png)
...
```
![버블차트](/image/3rd_week_image/21_1.png)
```
# 워드클라우드
...
3. 차원값으로 색상 표시
```
![워드클라우드](/image/3rd_week_image/21_2.png)
...
#### 이중축
![1](/image/3rd_week_image/22_1.png)
```
수익, 매출 그래프 각각 생성
```
![2](/image/3rd_week_image/22_2.png)
```
이중축을 활용해 두 그래프 합차기
```
![3](/image/3rd_week_image/22_3.png)
```
축 동기화를 활용해 서로 다른 축 단위를 하나로 맞춰줌
```
![4](/image/3rd_week_image/22_4.png)
```
#결합된 축
...
![23_1](/image/3rd_week_image/23_1.png)

#### 분산형 차트
![23_2](/image/3rd_week_image/23_2.png)
```
분산형 차트 제작
제조업체->마크>세부정보
```
![23_3](/image/3rd_week_image/23_3.png)
```
...
#### 추세선
분석>추세선>드래그&드롭
![23_4](/image/3rd_week_image/23_4.png)

```
범주별 추세선
```
![23_5](/image/3rd_week_image/23_5.png)

```
전체 추세선
추세선 하나 우클릭->모든 추세선 편집->범주 체크해제
```
![23_6](/image/3rd_week_image/23_6.png)
...
![24_1](/image/3rd_week_image/24_1.png)
```
# 구간차원 생성
차원값 필드 우클릭->만들기>구간차원
...
```
![24_2](/image/3rd_week_image/24_2.png)
```
# 구간차원 없이 히스토그램 만들기
1. 수익필드->열 선반
2. 표현방식에서 히스토그램 선택
...
```
![24_3](/image/3rd_week_image/24_3.png)
```
# 로그변환하기
1. 세로축 우클릭
2. 축 편집
...
#### 박스플롯
- 데이터의 분포를 파악하는 데 사용
![25_1](/image/3rd_week_image/25_1.png)
![25_2](/image/3rd_week_image/25_2.png)
```
1. "세그먼트"필드와 "지역"필드 열 선반으로 드래그&드롭
2. "매출"필드 행 선반으로 드래그&드롭
3. 표현방식>박스플롯
```
![25_3](/image/3rd_week_image/25_3.png)
```
1. 마크에 있던 "지역"필드 열 선반으로 드래그&드롭
2. "고객 이름"필드 -> 마크>세부 정보
3. "세그먼트"필트 -> 마크>색상
```
![25_4](/image/3rd_week_image/25_4.png)
```
축 편집->로그변환
```
## 26강: 영역차트
...
![26_1](/image/3rd_week_image/26_1.png)
```
...
4. 표현방식>영역 차트 연속형
```
![26_2](/image/3rd_week_image/26_2.png)

```
수치를 보기 위해 레이블 표시
```
![26_3](/image/3rd_week_image/26_3.png)
...
#### 간트차트
- 시간 경과에 따른 기간을 시각화
![27_1](/image/3rd_week_image/27_1.png)
```
1. "배송 날짜"필드 우클릭+드래그>불연속형의 월 선택(#월별 데이터 분석)
2. "제품 범주"필드 행 선반으로
3. "배송 기간" 필드만들기 *(배송기간)=(주문날짜)-(배송날짜)
```
![27_2](/image/3rd_week_image/27_2.png)
...
3. 간트 차트로 변경
```
![27_3](/image/3rd_week_image/27_3.png)
```
1. "하위 범주" 필드를 행 선반으로 드래그&드롭
2. "고객 이름" 필드를 필터로 드래그&드롭
```
![27_4](/image/3rd_week_image/27_4.png)
```
1. "배송 형태"필드 -> 마크>색상
```
## 28강: 필터
...
![28_1](/image/3rd_week_image/28_1.png)
```
1. "범주","제품 이름","매출" 더블클릭
2. "제품이름"->필터로 드래그&드롭>상위>필드기준>상위,10기준,매출,합계
3. "범주"-> 필터로 드래그&드롭>기술만 체크
```
![28_2](/image/3rd_week_image/28_2.png)
```
...
![29_1](/image/3rd_week_image/29_1.png)
```
뷰에서 드래그 후 우클릭>그룹
```
![29_2](/image/3rd_week_image/29_2.png)
```
# 항목별로 묶을 필드를 선택해 만들기
"제품이름" 필드 우클릭>만들기>그룹
```
![29_3](/image/3rd_week_image/29_3.png)
```
그룹별로 막대그래프 완성
```
![29_4](/image/3rd_week_image/29_4.png)
```
...
```
![A1](/image/3rd_week_image/A1.png)
```
