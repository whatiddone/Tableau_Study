...
![30_1](/3rd_week_img/4th_week_img/30_1.png)
```
년, 분기, 월이 계층구조로 이루어져 있다.
```
![30_2](/3rd_week_img/4th_week_img/30_2.png)
```
계층 구성하는 법
```
![30_3](/3rd_week_img/4th_week_img/30_3.png)
```
...
![31_1](/3rd_week_img/4th_week_img/31_1.png)
```
집합 만드는 법
```
![31_2](/3rd_week_img/4th_week_img/31_2.png)
```
일반: 그룹 기능과 비슷하게 수동으로 데이터를 선택 
조건: 설정 조건에 충족되는 데이터를 묶어줌
상위: 테이블마다 상위/하위 N개 데이터를 묶어줌
```
![31_3](/3rd_week_img/4th_week_img/31_3.png)
```
